...
banner:
  ...
  author: "@naps62"
  title: ethui 1.13.0
  subtitle: Revamped UI
---

![ethui 1.13 release banner](./banner.png)
...
![ethui light mode interface](./light-mode.png)

![ethui dark mode interface](./dark-mode.png)
...
![proxy visualization in ethui](./proxies.png)
