...
import impersonator from './impersonator.mp4';

![ethui 0.5.0 impersonation banner](./banner.png)

# ethui 0.5.0 – Impersonation
...
<Embed url="https://github.com/iron-wallet/iron/releases/tag/v0.5.0" />
...
<Video controls src={impersonator} />
